...
{
    public function getCaloriesFromImage(string $url): AnalysisResult
    {
        $response =  OpenAI::chat()->create([
            'model' => 'gpt-4-vision-preview',
            'messages' => [
                ['role' => 'system', 'content' => static::FROM_IMG_PROMPT,],
        ...
        return new AnalysisResult(
            ...
            description: data_get($processed, 'description'),
        );
    }

    public function getCaloriesFromDescription(string $description): AnalysisResult
    {
        $response =  OpenAI::chat()->create([
            'model' => 'gpt-4',
            'messages' => [
                ['role' => 'system', 'content' => static::FROM_DESCRIPTION_PROMPT,],
